...
partial class Example
{
	partial struct Email : Definit.Validation.IIsValid<string>, Definit.Validation.IIsValid<Email, Email.Valid>
	{
		...
		public static Definit.Configuration.Example.Email Deserialize(string json) => new Definit.Configuration.Example.Email(JsonSerializer.Deserialize<string>(json)!);  
		...
		public readonly struct Valid : Definit.Validation.IValid<Definit.Configuration.Example.Email>, Definit.Validation.IValidBase<Definit.Configuration.Example.Email.Valid>
		{
		    ...
		    public static implicit operator Definit.Configuration.Example.Email(Valid value) => value.Value;
		    ...
		    {
		        var (_, error) = value.Validate(propertyName ?? Definit.Configuration.Example.Email._NAME);
