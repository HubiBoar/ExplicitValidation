...
{
    public static UnionsWrapper<T> Results<T>(this System.Collections.Generic.List<T> value)
    {
    ...
    public readonly struct UnionsWrapper<T>
    {
		...
		public U AddRange(System.Collections.Generic.IEnumerable<T> collection) 
		{
		    try
		    {
		...
		public U CopyTo(int index, T[] array, int arrayIndex, int count) 
		{
		    try
		    {
		...
		public U CopyTo(T[] array, int arrayIndex) 
		{
		    try
		    {
		...
		public U ForEach(System.Action<T> action) 
		{
		    try
		    {
		...
		public U Insert(int index, T item) 
		{
		    try
		    {
		...
		public U InsertRange(int index, System.Collections.Generic.IEnumerable<T> collection) 
		{
		    try
		    {
		...
		public U RemoveRange(int index, int count) 
		{
		    try
		    {
		...
		public U Reverse(int index, int count) 
		{
		    try
		    {
		...
		public U Sort(System.Collections.Generic.IComparer<T>? comparer) 
		{
		    try
		    {
		...
		public U Sort(System.Comparison<T> comparison) 
		{
		    try
		    {
		...
		public U Sort(int index, int count, System.Collections.Generic.IComparer<T>? comparer) 
		{
		    try
		    {
