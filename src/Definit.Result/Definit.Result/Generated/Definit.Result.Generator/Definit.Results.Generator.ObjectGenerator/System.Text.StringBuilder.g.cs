...
public static class StringBuilder__Auto__Extensions
{
    ...
    public readonly struct Wrapper
    {
		...
		public Error? CopyTo(int sourceIndex, char[] destination, int destinationIndex, int count)
		{
		    try
			{
		...
		public Error? CopyTo(int sourceIndex, System.Span<char> destination, int count)
		{
		    try
			{
