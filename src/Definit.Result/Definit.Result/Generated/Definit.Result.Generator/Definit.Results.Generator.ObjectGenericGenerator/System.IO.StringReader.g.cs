...
public static class StringReader__Auto__Extensions
{
    ...
    public readonly struct Wrapper
    {
		...
		public Either<Maybe<string?>, Error> ReadLine() 
		{
		    try
		    {
		        return new Either<Maybe<string?>, Error>(new Maybe<string?>(this.Value.ReadLine()));
		    }
		    catch (Exception exception)
		    {
		...
		public async System.Threading.Tasks.Task<Either<Maybe<string?>, Error>> ReadLineAsync() 
		{
		    try
		    {
		        return new Either<Maybe<string?>, Error>(new Maybe<string?>(await this.Value.ReadLineAsync()));
		    }
		    catch (Exception exception)
		    {
		        return new Either<Maybe<string?>, Error>(Error.Matches(exception).Error);
		...
		public async System.Threading.Tasks.ValueTask<Either<Maybe<string?>, Error>> ReadLineAsync(System.Threading.CancellationToken cancellationToken) 
		{
		    try
		    {
		        return new Either<Maybe<string?>, Error>(new Maybe<string?>(await this.Value.ReadLineAsync(cancellationToken)));
		    }
		    catch (Exception exception)
		    {
		        return new Either<Maybe<string?>, Error>(Error.Matches(exception).Error);
