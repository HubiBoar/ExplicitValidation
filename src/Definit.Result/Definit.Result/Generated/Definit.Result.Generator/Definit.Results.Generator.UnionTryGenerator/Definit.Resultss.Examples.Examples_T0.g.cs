...
public static class TryExamples<T0>
	where T0 : notnull
{
    public static U<Definit.Resultss.Examples.Examples<T0>, System.Exception> New() 
	{
	    try
	    {
	        return new Definit.Resultss.Examples.Examples<T0>();
	    }
	...
	public static U<System.Exception> PrivateRun2<T1>(string t) 
	{
	    try
	    {
