...
public static class List1_Extensions_U
{
    ...
    public readonly struct UnionsWrapper<T>
    {
        ...
        public U<System.Exception> Add(T item) 
		{
		    try
		    {
		        this.Value.Add(item);
		...
		public U<System.Exception> AddRange(System.Collections.Generic.IEnumerable<T> collection) 
		{
		    try
		    {
		...
		public U<System.Exception> Clear() 
		{
		    try
		    {
		        this.Value.Clear();
		...
		public U<System.Exception> CopyTo(int index, T[] array, int arrayIndex, int count) 
		{
		    try
		    {
		...
		public U<System.Exception> CopyTo(T[] array) 
		{
		    try
		    {
		...
		public U<System.Exception> CopyTo(T[] array, int arrayIndex) 
		{
		    try
		    {
		...
		public U<System.Exception> ForEach(System.Action<T> action) 
		{
		    try
		    {
		...
		public U<System.Exception> Insert(int index, T item) 
		{
		    try
		    {
		...
		public U<System.Exception> InsertRange(int index, System.Collections.Generic.IEnumerable<T> collection) 
		{
		    try
		    {
		...
		public U<System.Exception> RemoveAt(int index) 
		{
		    try
		    {
		...
		public U<System.Exception> RemoveRange(int index, int count) 
		{
		    try
		    {
		...
		public U<System.Exception> Reverse() 
		{
		    try
		    {
		        this.Value.Reverse();
		...
		public U<System.Exception> Reverse(int index, int count) 
		{
		    try
		    {
		...
		public U<System.Exception> Sort() 
		{
		    try
		    {
		        this.Value.Sort();
		...
		public U<System.Exception> Sort(System.Collections.Generic.IComparer<T>? comparer) 
		{
		    try
		    {
		...
		public U<System.Exception> Sort(System.Comparison<T> comparison) 
		{
		    try
		    {
		...
		public U<System.Exception> Sort(int index, int count, System.Collections.Generic.IComparer<T>? comparer) 
		{
		    try
		    {
		...
		public U<System.Exception> TrimExcess() 
		{
		    try
		    {
