...
public static class StringBuilder_Extensions_U
{
    ...
    public readonly struct UnionsWrapper
    {
		...
		public U<System.Exception> CopyTo(int sourceIndex, char[] destination, int destinationIndex, int count) 
		{
		    try
		    {
		...
		public U<System.Exception> CopyTo(int sourceIndex, System.Span<char> destination, int count) 
		{
		    try
		    {
