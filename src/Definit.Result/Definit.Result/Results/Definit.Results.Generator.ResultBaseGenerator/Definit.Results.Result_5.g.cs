	...
	where T4 : notnull
{
    ...
    {
        static Either<T0, T1, T2, T3, T4, Err> IResultBase<Either<T0, T1, T2, T3, T4, Err>>.FromException(Exception exception)
		{
		   return ErrorHelper.Matches<Err>(exception).Error;
		}
    }
    
    private Either<T0, T1, T2, T3, T4, Err> Either { get; }
	
	[Obsolete(DefaultConstructorException.Attribute, true)]
	public Result() => throw new DefaultConstructorException();
	
	public Result(Either<T0, T1, T2, T3, T4, Err> value) => Either = value;
	...
	public static implicit operator Result<T0, T1, T2, T3, T4>(Err value) => new (value);


    public readonly struct Error<TE0> : Error<TE0>.Base
		where TE0 : struct, IError<TE0>
	{
	    public interface Base : IResultBase<Either<T0, T1, T2, T3, T4, TE0>>
	    {
	        static Either<T0, T1, T2, T3, T4, TE0> IResultBase<Either<T0, T1, T2, T3, T4, TE0>>.FromException(Exception exception)
			{
			   return ErrorHelper.Matches<TE0>(exception).Error;
			}
	    }
	
	    private Either<T0, T1, T2, T3, T4, TE0> Either { get; }
		
		[Obsolete(DefaultConstructorException.Attribute, true)]
		public Error() => throw new DefaultConstructorException();
		
		public Error(Either<T0, T1, T2, T3, T4, TE0> value) => Either = value;
	...
	{
	    public interface Base : IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1>>
	    {
	        static Either<T0, T1, T2, T3, T4, TE0, TE1> IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1>>.FromException(Exception exception)
			{
	    ...
	    private Either<T0, T1, T2, T3, T4, TE0, TE1> Either { get; }
		
		[Obsolete(DefaultConstructorException.Attribute, true)]
		public Error() => throw new DefaultConstructorException();
		
		public Error(Either<T0, T1, T2, T3, T4, TE0, TE1> value) => Either = value;
	...
	{
	    public interface Base : IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1, TE2>>
	    {
	        static Either<T0, T1, T2, T3, T4, TE0, TE1, TE2> IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1, TE2>>.FromException(Exception exception)
			{
			    var TE0_match = ErrorHelper.Matches<TE0>(exception);
	    ...
	    private Either<T0, T1, T2, T3, T4, TE0, TE1, TE2> Either { get; }
		
		[Obsolete(DefaultConstructorException.Attribute, true)]
		public Error() => throw new DefaultConstructorException();
		
		public Error(Either<T0, T1, T2, T3, T4, TE0, TE1, TE2> value) => Either = value;
	...
	{
	    public interface Base : IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3>>
	    {
	        static Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3> IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3>>.FromException(Exception exception)
			{
			    var TE0_match = ErrorHelper.Matches<TE0>(exception);
	    ...
	    private Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3> Either { get; }
		
		[Obsolete(DefaultConstructorException.Attribute, true)]
		public Error() => throw new DefaultConstructorException();
		
		public Error(Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3> value) => Either = value;
	...
	{
	    public interface Base : IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3, TE4>>
	    {
	        static Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3, TE4> IResultBase<Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3, TE4>>.FromException(Exception exception)
			{
			    var TE0_match = ErrorHelper.Matches<TE0>(exception);
	    ...
	    private Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3, TE4> Either { get; }
		
		[Obsolete(DefaultConstructorException.Attribute, true)]
		public Error() => throw new DefaultConstructorException();
		
		public Error(Either<T0, T1, T2, T3, T4, TE0, TE1, TE2, TE3, TE4> value) => Either = value;
