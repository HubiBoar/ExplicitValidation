...
public interface IUnionInfo<T0, T1, T2, T3, T4, T5, T6> : IUnionBase<(Or<T0>?, Or<T1>?, Or<T2>?, Or<T3>?, Or<T4>?, Or<T5>?, Or<T6>?)>
	where T0 : notnull
	where T1 : notnull
	where T2 : notnull
	where T3 : notnull
...
public readonly struct U<T0, T1, T2, T3, T4, T5, T6> : U<T0, T1, T2, T3, T4, T5, T6>.Base
	where T0 : notnull
	where T1 : notnull
	where T2 : notnull
	where T3 : notnull
	...
	where T6 : notnull 
{
    public interface Base : IUnionInfo<T0, T1, T2, T3, T4, T5, T6>;
	...
	public U(T0 value) => Value = (value!, null, null, null, null, null, null);
	public U(T1 value) => Value = (null, value!, null, null, null, null, null);
	public U(T2 value) => Value = (null, null, value!, null, null, null, null);
	public U(T3 value) => Value = (null, null, null, value!, null, null, null);
	public U(T4 value) => Value = (null, null, null, null, value!, null, null);
	public U(T5 value) => Value = (null, null, null, null, null, value!, null);
	public U(T6 value) => Value = (null, null, null, null, null, null, value!);
	
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>([DisallowNull] Definit.Results.UnionMatchError _) => throw new Definit.Results.UnionMatchException<U<T0, T1, T2, T3, T4, T5, T6>>();
	
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T0 value) => new (value);
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T1 value) => new (value);
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T2 value) => new (value);
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T3 value) => new (value);
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T4 value) => new (value);
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T5 value) => new (value);
	public static implicit operator U<T0, T1, T2, T3, T4, T5, T6>(T6 value) => new (value);
	...
	)
	{
	    try
	    {
	        var (_arg0,_arg1,_arg2,_arg3,_arg4,_arg5,_arg6) = this.Value;
	    ...
	    throw new Definit.Results.UnionMatchException<U<T0, T1, T2, T3, T4, T5, T6>>(); 
	}
...
public static class Extensions_U_7
{
    public static void Deconstruct<T0, T1, T2, T3, T4, T5, T6>
	(
	    this U<T0, T1, T2, T3, T4, T5, T6> either,
	    out T0? _arg_0,
		out T1? _arg_1,
		out T2? _arg_2,
		out T3? _arg_3,
		...
		where T6 : struct
	{
	    var (_out_0, _out_1, _out_2, _out_3, _out_4, _out_5, _out_6) = either.Value;
		...
		where T6 : struct
	{
	    if(either is null)
	    {
	        _arg_0 = null; _arg_1 = null; _arg_2 = null; _arg_3 = null; _arg_4 = null; _arg_5 = null; _arg_6 = null;
	        return;
	    }
	
	    var (_out_0, _out_1, _out_2, _out_3, _out_4, _out_5, _out_6) = either.Value.Value;
	    _arg_0 = _out_0?.Out ?? null;
		_arg_1 = _out_1?.Out ?? null;
		_arg_2 = _out_2?.Out ?? null;
		_arg_3 = _out_3?.Out ?? null;
