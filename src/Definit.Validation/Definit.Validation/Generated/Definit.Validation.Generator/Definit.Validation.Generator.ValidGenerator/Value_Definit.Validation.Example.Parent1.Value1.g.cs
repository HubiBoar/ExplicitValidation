...
partial class Example
{
	partial class Parent1
	{
		partial struct Value1 : Definit.Validation.IIsValid<string>, Definit.Validation.IIsValid<Value1, Value1.Valid>
		{
			...
			{
			    Definit.Validation.Example.Parent1.Value1 Definit.Validation.IValid<Definit.Validation.Example.Parent1.Value1>.Value => this._Parent;
			
			    public string Value => _Parent.Value;
			
			    public Definit.Validation.Example.Parent1.Value1 _Parent { get; }
			    ...
			    public static implicit operator Definit.Validation.Example.Parent1.Value1(Valid value) => value.Value;
			    ...
			    {
			        var (_, error) = value.Validate(propertyName ?? Definit.Validation.Example.Parent1.Value1._NAME);
			    ...
			    public static string Serialize(Valid valid) => Definit.Validation.Example.Parent1.Value1.Serialize(valid._Parent);
			}
		}
	}
}