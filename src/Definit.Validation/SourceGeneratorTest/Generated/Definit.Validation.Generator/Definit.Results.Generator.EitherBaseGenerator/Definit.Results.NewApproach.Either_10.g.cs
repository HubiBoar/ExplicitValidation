...
public interface IEither<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IEitherBase<(Or<T0>?, Or<T1>?, Or<T2>?, Or<T3>?, Or<T4>?, Or<T5>?, Or<T6>?, Or<T7>?, Or<T8>?, Or<T9>?)>
    where T0 : notnull
	where T1 : notnull
	where T2 : notnull
	where T3 : notnull
...
public readonly struct Either<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> : IEither<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> 
    where T0 : notnull
	where T1 : notnull
	where T2 : notnull
	where T3 : notnull
	...
	where T9 : notnull
{
    ...
    // public static implicit operator Either<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(Either<T1, T0> value) => new (value);
}
...
public static partial class EitherExtensions
{
    ...
    (
		...
		where T9 : struct
    {
        var (t_0, t_1, t_2, t_3, t_4, t_5, t_6, t_7, t_8, t_9) = result.Value;
