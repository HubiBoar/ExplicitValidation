...
{
	readonly partial struct Either<T0> where T0 : notnull
	{
		...
		public static implicit operator Either<T0>([DisallowNull] ResultMatchError value) => throw new ResultMatchException<Definit.Results.NewApproach.Either<T0>>(); 
