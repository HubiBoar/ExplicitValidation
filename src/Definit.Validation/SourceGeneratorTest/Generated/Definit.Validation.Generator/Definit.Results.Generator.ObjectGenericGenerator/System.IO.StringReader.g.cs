...
public static class StringReader__Auto__Extensions
{
    ...
    public readonly struct Wrapper
    {
		...
		public Either<string?, Error> ReadLine()
		{
		    try
		    {
		        return new Either<string?, Error>((this.Value.ReadLine())!);
		    }
		    catch (Exception exception)
		    {
		...
		public async Task<Either<string?, Error>> ReadLineAsync()
		{
		    try
		    {
		        return new Either<string?, Error>((await this.Value.ReadLineAsync())!);
		    }
		    catch (Exception exception)
		    {
		        return new Either<string?, Error>(Error.Matches(exception).Error);
		...
		public async ValueTask<Either<string?, Error>> ReadLineAsync(System.Threading.CancellationToken cancellationToken)
		{
		    try
		    {
		        return new Either<string?, Error>((await this.Value.ReadLineAsync(cancellationToken))!);
		    }
		    catch (Exception exception)
		    {
		        return new Either<string?, Error>(Error.Matches(exception).Error);
