...
namespace Definit.Resultss.Examples
{
	readonly partial struct ResultExample2<T> where T : notnull
	{
		...
		public static implicit operator ResultExample2<T>([DisallowNull] T value) => new (value);
		public static implicit operator ResultExample2<T>([DisallowNull] string value) => new (value);
		public static implicit operator ResultExample2<T>([DisallowNull] Definit.Resultss.Examples.NotFound value) => new (value);
	}
}