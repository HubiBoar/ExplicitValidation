...
public readonly partial struct Result : Result.Base
{
	    ...
	    where TE0 : struct, IError<TE0>
	{
		...
		public static implicit operator Error<TE0>(Success value) => new (value);
		...
		where TE1 : struct, IError<TE1>
	{
		...
		public static implicit operator Error<TE0, TE1>(Success value) => new (value);
		...
		where TE2 : struct, IError<TE2>
	{
		...
		public static implicit operator Error<TE0, TE1, TE2>(Success value) => new (value);
		...
		where TE3 : struct, IError<TE3>
	{
		...
		public static implicit operator Error<TE0, TE1, TE2, TE3>(Success value) => new (value);
		...
		where TE4 : struct, IError<TE4>
	{
		...
		public static implicit operator Error<TE0, TE1, TE2, TE3, TE4>(Success value) => new (value);
